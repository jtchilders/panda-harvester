#!/usr/bin/env python
import os,sys,optparse,logging,sqlite3,datetime
...
def main():
   ...
   parser.add_option('-t','--time-in-hours',dest='hours',help='this prints the workers last modified in the last N hours. last-n-workers and time-in-hours are mutually exclusive.',type='int')
   parser.add_option('-n','--last-n-workers',dest='workers',help='this prints the last N workers created. last-n-workers and time-in-hours are mutually exclusive.',type='int')
